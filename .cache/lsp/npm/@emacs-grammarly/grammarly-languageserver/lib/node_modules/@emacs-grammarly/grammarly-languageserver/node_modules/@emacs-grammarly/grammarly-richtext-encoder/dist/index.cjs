...
const markdown = createTransformer({
    ...
    processNode(node, insert) {
        var _a, _b, _c, _d, _e;
        if (node.type === 'text') {
            if (((_b = (_a = node.parent) === null || _a === void 0 ? void 0 : _a.parent) === null || _b === void 0 ? void 0 : _b.type) === 'atx_heading' && ((_c = node.parent.firstChild) === null || _c === void 0 ? void 0 : _c.equals(node))) {
                insert(node.text.slice(1), node, 1);
            }
            else if (((_d = node.parent) === null || _d === void 0 ? void 0 : _d.type) === 'paragraph' &&
                node.text.startsWith(': ') &&
                ((_e = node.parent.firstChild) === null || _e === void 0 ? void 0 : _e.equals(node))) {
